...
:root{color-scheme:light dark}*{box-sizing:border-box}body{font-family:var(--vscode-font-family);font-size:13px;color:var(--vscode-foreground);margin:0;padding:14px;line-height:1.4}.shell{max-width:760px;margin:0 auto}.title{font-size:18px;font-weight:600;margin:0 0 12px;overflow:hidden;text-overflow:ellipsis}.actions{display:flex;flex-wrap:wrap;gap:5px;margin-bottom:22px}.action,.add,.remove{font:inherit;border:0;border-radius:2px;cursor:pointer}.action{padding:4px 9px;color:var(--vscode-button-secondaryForeground);background:var(--vscode-button-secondaryBackground)}.action:hover{background:var(--vscode-button-secondaryHoverBackground)}.section{margin-top:20px}.section-head{display:flex;align-items:center;justify-content:space-between;margin-bottom:7px}.section-title{font-size:13px;font-weight:600}.count{color:var(--vscode-descriptionForeground);font-size:11px}.panel{border:1px solid var(--vscode-panel-border);background:var(--vscode-sideBar-background)}.installed{display:flex;align-items:center;gap:8px;min-height:34px;padding:5px 7px 5px 10px;border-bottom:1px solid var(--vscode-panel-border)}.installed:last-child{border-bottom:0}.package-name{min-width:0;flex:1;overflow:hidden;text-overflow:ellipsis}.remove{width:24px;height:24px;flex:none;color:var(--vscode-descriptionForeground);background:transparent;font-size:16px;line-height:1}.remove:hover{color:var(--vscode-errorForeground);background:var(--vscode-toolbar-hoverBackground)}.empty{padding:14px;text-align:center;color:var(--vscode-descriptionForeground)}.search-wrap{position:relative}.search-icon{position:absolute;left:9px;top:50%;transform:translateY(-50%);color:var(--vscode-descriptionForeground);pointer-events:none}input{width:100%;height:32px;padding:0 34px 0 29px;border:1px solid var(--vscode-input-border,var(--vscode-panel-border));border-radius:2px;color:var(--vscode-input-foreground);background:var(--vscode-input-background);font:inherit;outline:none}input:focus{border-color:var(--vscode-focusBorder)}.spinner{display:none;position:absolute;right:10px;top:8px;width:14px;height:14px;border:2px solid var(--vscode-panel-border);border-top-color:var(--vscode-progressBar-background);border-radius:50%;animation:spin .7s linear infinite}.loading .spinner{display:block}@keyframes spin{to{transform:rotate(360deg)}}.results{margin-top:6px}.result{display:grid;grid-template-columns:1fr auto;gap:6px 10px;padding:9px 10px;border-bottom:1px solid var(--vscode-panel-border)}.result:last-child{border-bottom:0}.result-name{font-weight:600}.description{margin-top:2px;color:var(--vscode-descriptionForeground);display:-webkit-box;-webkit-line-clamp:2;-webkit-box-orient:vertical;overflow:hidden}.meta{display:flex;flex-wrap:wrap;gap:8px;margin-top:5px;color:var(--vscode-descriptionForeground);font-size:10px}.chip{font-size:10px}.add{align-self:center;padding:4px 9px;color:var(--vscode-button-foreground);background:var(--vscode-button-background)}.add:hover{background:var(--vscode-button-hoverBackground)}.add:disabled{opacity:.55;cursor:default}.error{padding:10px;color:var(--vscode-errorForeground)}
